...
base_urls = [
    "https://pudhari.news/category/maharashtra/page/",
    "https://pudhari.news/category/national/page/",
    "https://pudhari.news/category/international/page/",
    "https://pudhari.news/category/sports/page/",
    "https://pudhari.news/category/sampadakiy/page/",
    "https://pudhari.news/category/soneri/page/",
    "https://pudhari.news/category/vishwasanchar/page/",
    "https://pudhari.news/category/features/page/",
]

base_url = "https://pudhari.news/category/maharashtra/page/"

start_page = 3001
# end_pages=[9801, 1671, 597, 790, 265, 928, 603, 974]
end_page = 4000
# print(len(base_urls), len(end_page))
section_name = "maharashtra"
file_name = f"Shardul/Pudhari News/{section_name}_articles.txt"
...
# get_article_urls('https://pudhari.news/category/maharashtra/page/1/')
...
def scrape_article(url):
    ...
    for attempt in range(retries):  # Retry logic
        try:
            ...
            article_title = (
                article_title_tag.text.strip() if article_title_tag else "No Title"
            )
            # print(article_title)
            ...
            text = ""
            if content_div:
                paragraphs = content_div.find_all(["p", "h3"], recursive=False)
                # print(paragraphs)
                # print("-----------------------------------------------------")
...
# scrape_article('https://pudhari.news/maharashtra/pune/805340/the-charisma-of-solidarity-in-rajgad-decisive-lead-to-supriya-sule/ar')
